...
public class StudentDAO {
	...
	public boolean addStudent(Student student) {
		...
		try {
			...
			String sql = "Insert into Student(fullName, dob, addr, qualification, email) values (?,?,?,?,?)";
...
try {
	...
	public boolean updateStudent(Student student) {
		...
		try {
			...
			String sql = "update Student set FullName = ? , Dob = ? , Addr = ?, Qualification =?,Email = ? where id =?";
